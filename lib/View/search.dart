          ...
          children: [
            ...
            Expanded(
                child: isLoading
                    ...
                    : (products == null && searchType == "product" ||
                            shops!.isEmpty && searchType == "store")
  ...
  void initState() {
    ...
    _animations = List.generate(
      ...
      (index) => Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
          parent: _controller, curve: Interval(index * 0.2, 1.0))),
    );
  }
  ...
  Widget build(BuildContext context) {
    return widget.searchType == "store"
            ...
            itemBuilder: (context, index) {
              return AnimatedBuilder(
                ...
                builder: (context, child) {
                  ...
                  double darkness =
                      0.4 + (index * 0.1); // Darker as you go down
                  return Opacity(
                    opacity: opacity,
                    child: Padding(
        ...
        : GridView.builder(
            ...
            itemCount:
                6, // Adjust to match the number of items in the loading animation
            itemBuilder: (context, index) {
              return AnimatedBuilder(
                animation: _animations[index],
                builder: (context, child) {
