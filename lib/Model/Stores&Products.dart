...
class Product {
  ...
  factory Product.fromJson1(dynamic jsonData, int i) {
    return Product(
        id: jsonData[i]["id"],
        name: jsonData[i]["name"],
        picture: back_url + jsonData[i]["picture"],
        price: jsonData[i]["price"],
        description: jsonData[i]["description"],
        store_id: jsonData[i]['store_id'] ?? 1,
        favourite: jsonData[i]["favourite"],
        store_name: jsonData[i]["store_name"],
